...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _submitFormOnRegister() async {
    ...
    if (isValid) {
      ...
      // this setState should be inside this if check
      setState(() {
        _isLoading = true;
      });
      try {
        ...
        final _uid = user!.uid;
        user.updateDisplayName(_fullNameController.text); // L122
        user.reload(); // L122
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: Icon(
                      ...
                      // color: color, // (Or) underneath is also same
                    ...
                    child: TextButton(
                      onPressed: () {
                        GlobalMethods.navigateFromRight(
                            ctx: context, screen: ForgetPasswordScreen());
                      },
                      child: const Text(
                        'Forget password?',
                        maxLines: 1,
