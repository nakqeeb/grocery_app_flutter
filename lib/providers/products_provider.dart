...
class ProductsProvider with ChangeNotifier {
  ...
  List<ProductModel> get getOnSaleProducts {
    return _productsList.where((prod) => prod.isOnSale).toList();
  }
  ...
  Future<void> fetchProducts() async {
    await FirebaseFirestore.instance
      ...
      // set it to empty to avoid the duplication items. L106
      _productsList = []; // OR you cann use _productsList.clear()
      // _productsList.clear();
  ...
  ProductModel findProdById(String productId) {
    return _productsList.firstWhere((prod) => prod.id == productId);
  }

  List<ProductModel> findByCategory(String categoryName) {
    List<ProductModel> _categoryList = _productsList
        .where((prod) => prod.productCategoryName
            .toLowerCase()
