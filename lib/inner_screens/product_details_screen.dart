...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        // in my case, onWillPop will trigger only when I go back by device hardware back button
        // so I have to call the following line again down in onTap method
        ...
        appBar: AppBar(
            leading: InkWell(
              ...
              onTap: () {
                ...
                // call it agin here to trigger when press back icon
                viewedProdProvider.addProductToHistory(productId: productId);
              },
              child: Icon(
